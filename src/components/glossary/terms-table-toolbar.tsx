...
/** Filter/search toolbar + primary "New term" action. */
  ...
  return (
    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      <div className="flex flex-1 flex-col gap-2 sm:flex-row sm:items-center">
        ...
        <Select
          value={filters.level}
          onValueChange={(v) => update({ level: v as TermsTableFilters["level"] })}
        >
        ...
        <Select
          ...
          onValueChange={(v) => update({ status: v as TermsTableFilters["status"] })}
        >
