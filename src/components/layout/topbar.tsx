...
export function Topbar() {
  return (
    <header className="bg-background/80 supports-[backdrop-filter]:bg-background/60 sticky top-0 z-30 flex h-14 w-full items-center gap-2 border-b pe-3 backdrop-blur-sm">
      ...
      <div className="relative hidden max-w-sm flex-1 sm:block">
        ...
        <Input
          type="search"
          placeholder="بحث في قاعدة المعرفة، الأسئلة…"
          className="bg-muted/50 border-transparent h-8 ps-8 text-sm shadow-none focus-visible:bg-background"
          aria-label="بحث"
        />
      </div>
