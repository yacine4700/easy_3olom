import { LayoutDashboard, Library, MessageCircleQuestion, Route, BookText, ChartNoAxesColumn, Settings, ClipboardList, CreditCard } from "lucide-react";
...
export const navConfig: NavConfig = [
  ...
  { key: "engagement", label: "التفاعل", items: [
    ...
    { key: "subscriptions", title: "الاشتراكات", href: "/subscriptions", icon: CreditCard, description: "إدارة المستخدمين والاشتراكات والمدفوعات" },
